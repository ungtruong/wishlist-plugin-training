...
abstract class AbstractLoadWishlistRoute
{
    ...
    abstract public function load(Request $request, SalesChannelContext $context, Criteria $criteria, CustomerEntity $customer, String $wishlistId): LoadWishlistRouteResponse;
}
