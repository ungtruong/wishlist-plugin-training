...
* The wishlist feature has to be activated.",
     ...
     */
    public function delete(string $wishlistProductId, SalesChannelContext $context, CustomerEntity $customer): SuccessResponse
    {
    ...
    public function deleteAll(string $wishlistId, SalesChannelContext $context, CustomerEntity $customer): SuccessResponse
    {
        ...
        $wishlistProductIds = $this->productRepository->searchIds($criteria, $context->getContext());
        $dataDelete = [];
        $ids = $wishlistProductIds->getIds();
        foreach ($ids as $id) {
            $dataDelete[] = ['id' => $id];
        }
        if ($dataDelete) {
            $this->productRepository->delete($dataDelete, $context->getContext());
        }
    ...
    public function deleteWishlistProduct(string $wishlistId, String $productId, SalesChannelContext $context, CustomerEntity $customer): SuccessResponse
    {
        $id = $this->getWishlistProductId($wishlistId, $productId, $context);
        if ($id) {
            $this->productRepository->delete([
                [
                    'id' => $id,
