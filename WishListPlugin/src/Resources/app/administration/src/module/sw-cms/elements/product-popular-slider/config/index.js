import template from './sw-cms-el-config-product-popular-slider.html.twig';
import './sw-cms-el-config-product-popular-slider.scss';


const { Component, Mixin } = Shopware;
const { Criteria, EntityCollection } = Shopware.Data;

Component.register('sw-cms-el-config-product-popular-slider', {
    template,
