import template from './sw-cms-el-product-popular-slider.html.twig';
import './sw-cms-el-product-popular-slider.scss';

const { Component, Mixin } = Shopware;

Component.register('sw-cms-el-product-popular-slider', {
    template,
